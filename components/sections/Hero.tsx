        ...
        >
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter">
              {"Kunj Arora".split(" ").map((word, wordIndex) => (
                <span
                  key={wordIndex}
          ...
          >
            ...
            >
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 text-center">
          ...
          >
            ...
            >
              <a
                href="https://linkedin.com/in/kunjarora23"
                target="_blank"
            ...
            >
              <a
                href="https://github.com/KunjArora23"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2"
              >
            ...
            >
              <a
                href="mailto:kunjaroraof@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2"
              >
                <Mail className="w-5 h-5 group-hover:text-pink-600" />
                <span>Email</span>
                <ExternalLink className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
              </a>
            </Button>
